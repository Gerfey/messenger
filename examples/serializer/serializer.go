...
import (
	...
	"github.com/gerfey/messenger/examples/serializer/handler"
	"github.com/gerfey/messenger/examples/serializer/message"
	"github.com/gerfey/messenger/examples/serializer/serializer"
)
...
func main() {
	...
	cfg, err := config.LoadConfig("./examples/serializer/messenger.yaml")
	if err != nil {
	...
	b.RegisterSerializer("test.json", serializer.NewTestSerializer())
