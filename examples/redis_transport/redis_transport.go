...
import (
	...
	"github.com/gerfey/messenger/examples/redis_transport/handler"
	"github.com/gerfey/messenger/examples/redis_transport/message"
)
...
func main() {
	...
	cfg, err := config.LoadConfig("./examples/redis_transport/messenger.yaml")
	if err != nil {
